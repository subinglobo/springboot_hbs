package com.choosenfly.hotelbookingsystem.api.iwtx.controller;
...
@RestController
@RequestMapping("/api/iwtx/hotel")
@Tag(name = "IWTX Hotel Availability", description = "APIs for checking hotel room availability and pricing through IWTX")
public class IwtxHotelAvailabilityController {
    ...
    @Operation(summary = "Check hotel room availability and pricing", 
               description = "Check hotel room availability and pricing from IWTX API. Profile credentials are automatically populated from configuration.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> checkHotelAvailability(
        ...
        try {
            HotelSearchResponse response = iwtxHotelAvailabilityService.checkHotelAvailability(request);
    ...
    public ResponseEntity<?> getSampleRequest(
        ...
        try {
            HotelSearchRequest sampleRequest = iwtxHotelAvailabilityService.createSampleRequest(
