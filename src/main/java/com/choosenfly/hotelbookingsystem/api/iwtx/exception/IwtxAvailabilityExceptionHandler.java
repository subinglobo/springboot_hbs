...
public class IwtxAvailabilityExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleIwtxAvailabilityException(
            IwtxAvailabilityException ex, WebRequest request) {
        
        Map<String, Object> errorResponse = new HashMap<>();
        errorResponse.put("timestamp", LocalDateTime.now());
        errorResponse.put("status", HttpStatus.BAD_REQUEST.value());
        errorResponse.put("error", "IWTX Availability API Error");
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(
        ...
        errorResponse.put("message", "An unexpected error occurred while processing IWTX availability request");
