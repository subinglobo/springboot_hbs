...
public class RoomIwtxResponse {
	...
	/**
	 * @return the totalRateWithMarkup
	 */
	public double getTotalRateWithMarkup() {
		return totalRateWithMarkup;
	}
	/**
	 * @param totalRateWithMarkup the totalRateWithMarkup to set
	 */
...
//	@XmlAttribute(name = "RoomNo")
	...
	public String getNewFlexi() {
		return newFlexi;
	}
	public void setNewFlexi(String newFlexi) {
		this.newFlexi = newFlexi;
	}
	/**
...
//	@XmlAttribute(name = "ContractLabel")
	...
	public String toString() {
		return "Room [RoomNo=" + RoomNo + ", RoomType=" + RoomType + ", RoomTypeCode=" + RoomTypeCode
