...
public class HotelSpecialRateBlockDTO {
    ...
    // Constructors
    public HotelSpecialRateBlockDTO() {}

    public HotelSpecialRateBlockDTO(Long hotel_id, Long hotel_room_category_id, String block_date, 
