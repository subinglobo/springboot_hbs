...
public class HotelContractRateDTO {
    ...
    // Constructors
    public HotelContractRateDTO() {}

    public HotelContractRateDTO(Long hotel_id, Long hotel_room_category_id, BigDecimal rate, 
                               String rate_date, String validity_from, String validity_to, 
                               String currency, Integer priority) {
