package com.choosenfly.hotelbookingsystem.api.x3.service;
...
public interface X3HotelAvailabilityService {
    
    /**
     * Check hotel room availability and pricing from X3 API
     * 
