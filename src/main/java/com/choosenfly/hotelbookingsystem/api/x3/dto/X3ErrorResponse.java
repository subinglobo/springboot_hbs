...
/**
 * Standard error response DTO for X3 API
 */
public class X3ErrorResponse {
    ...
    public X3ErrorResponse() {
        this.timestamp = LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME);
    }
    
    public X3ErrorResponse(String code, String message, String path) {
        this();
        this.error = new ErrorDetails(code, message);
        this.path = path;
    }
    
    public X3ErrorResponse(String code, String message, String details, String path) {
        this();
